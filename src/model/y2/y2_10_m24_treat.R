...
y2_m24_treat_groups_list <- m24_treat_groups(input_df = m24_FU_input_df,
...
y2_m24_add_diags_df <- y2_m24_treat_groups_list[[2]]
...
m48_FU_input_df <- y2_m24_treat_groups_list[[4]]
