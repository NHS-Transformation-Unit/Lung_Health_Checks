initial_treat_groups <- function(input_df, diagnostic_rate, incidental_rate, follow_up_rate, 
  ...
  initial_incidental_df <- initial_treat_outcome_df %>%
    filter(init_treat_outcome == "Incidental")
  ...
  return(list(initial_treat_outcome_agg_df, initial_treat_diags_df, initial_treat_3m_fu_df, initial_treat_diags_outcome_agg_df, initial_treat_cancer_output_df, initial_incidental_df))
...
initial_incidental_findings <- function(input_df, cc_rate, emp_rate, ila_rate, meda_rate, avc_rate, 
  ...
  initial_incidental_findings_df <- input_df %>%
  ...
  initial_incidental_findings_agg_df <- initial_incidental_findings_df %>%
