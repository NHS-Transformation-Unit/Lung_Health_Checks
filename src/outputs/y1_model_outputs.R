...
y1_pop_coverage_op <- y2_screened_input_df
...
y1_init_inc_op <- y1_init_incidental_df
...
y1_m3_inc_op <- y1_m3_incidental_df
...
y1_m12_inc_op <- y1_m12_incidental_df
...
y1_m24_inc_op <- y1_m24_incidental_df
...
excel_output(
  ...
  list(
    y1_pop_coverage_op = y1_pop_coverage_op,
