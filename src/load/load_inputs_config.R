...
input_file_name <- "lhc_config_inputs_v4_test_alt.xlsx"
...
assumptions_m12_inc <- read_excel(paste0(here(), "/data/config_inputs/", input_file_name), sheet = "m12_incidental", range = "B2:I23")
...
assumptions_m24_inc <- read_excel(paste0(here(), "/data/config_inputs/", input_file_name), sheet = "m24_incidental", range = "B2:I23")
