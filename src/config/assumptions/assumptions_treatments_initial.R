...
initial_inc_fra_y1 <- assumptions_initial_inc[[17,4]]
initial_inc_fra_y2 <- assumptions_initial_inc[[17,5]]
initial_inc_fra_y3 <- assumptions_initial_inc[[17,6]]
initial_inc_fra_y4 <- assumptions_initial_inc[[17,7]]
initial_inc_fra_y5 <- assumptions_initial_inc[[17,8]]

initial_inc_thy_y1 <- assumptions_initial_inc[[18,4]]
initial_inc_thy_y2 <- assumptions_initial_inc[[18,5]]
initial_inc_thy_y3 <- assumptions_initial_inc[[18,6]]
initial_inc_thy_y4 <- assumptions_initial_inc[[18,7]]
initial_inc_thy_y5 <- assumptions_initial_inc[[18,8]]

initial_inc_aaa_y1 <- assumptions_initial_inc[[19,4]]
initial_inc_aaa_y2 <- assumptions_initial_inc[[19,5]]
initial_inc_aaa_y3 <- assumptions_initial_inc[[19,6]]
initial_inc_aaa_y4 <- assumptions_initial_inc[[19,7]]
initial_inc_aaa_y5 <- assumptions_initial_inc[[19,8]]

initial_inc_tub_y1 <- assumptions_initial_inc[[20,4]]
initial_inc_tub_y2 <- assumptions_initial_inc[[20,5]]
initial_inc_tub_y3 <- assumptions_initial_inc[[20,6]]
initial_inc_tub_y4 <- assumptions_initial_inc[[20,7]]
initial_inc_tub_y5 <- assumptions_initial_inc[[20,8]]
