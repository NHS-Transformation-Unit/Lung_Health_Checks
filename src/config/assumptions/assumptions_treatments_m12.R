...
m12_diagnostic_rate <- assumptions_m12_treat[[1,4]]
m12_m24_fu_rate <- 1 - m12_diagnostic_rate

m12_cancer_rate <- assumptions_m12_treat[[2,4]]
...
m12_treatment_df <- data.frame(
  Modality = c("Surgery",
               ...
               "Chemotherapy",
               "No Treatment or BSC"),
  Rates = c(assumptions_m12_treat[[3,4]],
            assumptions_m12_treat[[4,4]],
            assumptions_m12_treat[[5,4]],
            assumptions_m12_treat[[6,4]],
