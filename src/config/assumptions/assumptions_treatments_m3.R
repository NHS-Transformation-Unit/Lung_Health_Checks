...
m3_diagnostic_rate <- assumptions_m3_treat[[1,4]]
m3_m12_fu_rate <- 1 - m3_diagnostic_rate

m3_cancer_rate <- assumptions_m3_treat[[2,4]]
...
m3_treatment_df <- data.frame(
  Modality = c("Surgery",
               ...
               "Chemotherapy",
               "No Treatment or BSC"),
  Rates = c(assumptions_m3_treat[[3,4]],
            assumptions_m3_treat[[4,4]],
            assumptions_m3_treat[[5,4]],
            assumptions_m3_treat[[6,4]],
